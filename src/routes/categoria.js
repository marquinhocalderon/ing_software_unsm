...
router.get("/auth/categoria", requireAuth, async function (req, res) {
  pool.query(
    "SELECT * FROM categoria",
    function (error, results, fields) {
      if (error) throw error;
      res.render("categoria", { categorias: results });
    }
  );
});

router.post("/auth/categoria", async (req, res) => {
...
router.get("/auth/actualizarcategoria/:id", requireAuth, async function (req, res) {
  ...
  try {
    ...
    res.render("categoria", { productos: results });
  } catch (error) {
    console.error(error);
...
router.post("/auth/actualizarcategoria/:id", requireAuth, async function (req, res) {
  const idCategoria = req.params.id;
  const { nombre_categoria, estado_categoria } = req.body;
  try {
