...
router.get("/lista", requireAuth, async function (req, res) {
    pool.query(
              ...
              function (error, categorias, fields3) {
                ...
                pool.query(
                  ...
                  function (error, unidades, fields3) {
                    if (error) throw error;
                    res.render("productos_almacenero", {
  ...
  router.post("/lista", requireAuth, function (req, res) {
  ...
  router.get("/lista/:id", requireAuth, async function (req, res) {
    try {
      const { id } = req.params;
  ...
  router.get("/auth/categoria1", otro, async function (req, res) {
  ...
  router.get("/auth/unidad1", otro, async function (req, res) {
  ...
  router.post("/actualizar/:id", requireAuth, async function (req, res) {
    const codigoProducto = req.body.codigo_producto;
    const nombreProducto = req.body.nombre_producto;
    const stock = req.body.stock;
    const precio_venta = req.body.precio_venta;
  ...
  router.delete("/eliminarcliente/:idproducto", async function (req, res) {
